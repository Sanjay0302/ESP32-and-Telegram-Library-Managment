...
{ 
  ...
  {
        String link ;
       telegramMessage &msg = bot.messages[i];    //shortcut
...
// Preparing the Reply Keyboard menu
  if (text == "/mathsnotes")
    {
  ...
  // Reply Keyboard prepared 
 


// assigning the feedback for commands received
  ...
  if (text == "nt_module3")
  {
    ...
    //assigning digital system design
  if (text == "dsd_module1")
  {
  ...
  if (text == "dsd_module3")
  {
    ...
    //asssigning Computer organisatiom 
  if (text == "co_module1")
  {
...
void loop()
{
  ...
  // to scan the api calls for set time repeatedly
